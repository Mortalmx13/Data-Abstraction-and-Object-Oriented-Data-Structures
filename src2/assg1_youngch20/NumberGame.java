	...
	public class NumberGame {
		...
		public static void main(String[] args) {
		    ...
		    while(num <= 0) {
		        ...
		        if (number == Result) {
		        	//this is what happens when the user guesses right within 5 tries
